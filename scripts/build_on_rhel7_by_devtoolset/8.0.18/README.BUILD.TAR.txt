Build on K1 Power9 Linux, RedHat 7.6 (Kernel 4.14.0-115.8.1.el7a.ppc64le) with devtoolset-8.
...
# cd /opt/mysql
# tar zcf mysql-community-8.0.18-1.el7.ppc64le.bin.tar.gz ./8.0.18
