Build on K1 Power9 Linux, RedHat 7.6 (Kernel 4.14.0-115.10.1.el7a.ppc64le) with devtoolset-9.
...
# cmake3 -LHA .. \
  ...
  -DCMAKE_INSTALL_PREFIX=/opt/mysql/8.0.36 \
...
# cd /opt/mysql
# tar zcf mysql-community-8.0.36-1.el7.ppc64le.bin.tar.gz ./8.0.36
